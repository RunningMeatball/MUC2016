#pragma config(Sensor, S1,     sensorL,        sensorEV3_Color)
#pragma config(Sensor, S2,     sensorF,        sensorEV3_Color)
#pragma config(Sensor, S3,     sensorR,        sensorEV3_Color)
...
// Black is 7, red is 60, white is 75, blue is 12, and yellow is 89
...
void moveForward(bool detect, bool isParking){
	...
	while(!(SensorValue[sensorF] >= red1 && SensorValue[sensorF] <= red2)){} // while it is not red
	motor[motorL] = 0;
	motor[motorR] = 0;
}
